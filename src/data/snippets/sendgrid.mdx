    ...
    await sendgrid.send({
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
              ...
              <p>Meanwhile, <a class="blog" href="https://Saivamshi.in/blog/" style="text-decoration: none;color: blue;font-weight: bold;">checkout my blog</a> to get more insights about my work.</p>
              ...
              <img src="https://Saivamshi.in/logo.png" class="logo-image" style="height: 50px;width: 50px;border-radius: 5px;overflow: hidden;">
              ...
              <div class="footer-links" style="display: flex;justify-content: center;align-items: center;">
                <a href="https://Saivamshi.in/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">Website</a>
                <a href="https://Saivamshi.in/blog/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">Blog</a>
                <a href="https://github.com/Saivamshi700/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">GitHub</a>
                <a href="https://instagram.com/maninthere/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">Instagram</a>
                <a href="https://linkedin.com/in/Saivamshi28/" style="text-decoration: none;margin: 8px;color: #9CA3AF;">LinkedIn</a>
...
A live demo of this API can be found on my [homepage](https://Saivamshi.in). I've used Sendgrid on my `Contact` component on the Home Page and Blog page.

<!--
  [Live Demo](http://Saivamshi.in/demos/demo/movingcard)
  [Source Code](https://github.com/Saivamshi700/portfolio-website/tree/master/pages/demos/demo/movingcard) -->
