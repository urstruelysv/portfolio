...
const techTalks = [
  {
    ...
    description:
      "I talk about how to create a targeted website to land more job interviews and freelance clients with all the other things that matter. Hosted on codementor.",
  ...
  },
  {
    ...
    description:
      "Talked about how to effectively utilise a portfolio website to put yourself in the best position to win.",
  ...
  },
  {
    ...
    description:
      "Algochurn is a free resource that helps front-end developers practice machine coding questions. Here I talk about how to effectively make use of Algochurn.",
    platform: "Youtube",
  ...
  },
  {
    ...
    description:
      "Debouncing is a method of preventing a function from being invoked too often. In this video, I talk about how to create a custom debounce function from scratch.",
    platform: "Youtube",
          ...
          <Link key={index} href={talk.href} className="block">
            <div className="rounded-xl border bg-white shadow hover:shadow-lg transition-shadow duration-200 cursor-pointer">
              <div
                ...
                style={{
                  backgroundImage: `url(${talk.thumbnail})`,
