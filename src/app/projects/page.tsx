...
const projects = [
  ...
  },
  {
    title: "EchoBoard",
    description:
      "Privacy-first feedback widget. Drop-in, lightweight solution for collecting user comments on any site.",
  ...
  },
  {
    ...
    description:
      "AI-powered content agency. Turn viewer engagement into revenue with automated video solutions.",
